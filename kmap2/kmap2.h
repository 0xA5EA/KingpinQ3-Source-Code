...
void            EmitMetaStats(void);	// vortex: print meta statistics even in no-verbose mode
...
Q_EXTERN const vec3_t       LUMINANCE_VECTOR	/* should be the same as in KingpinQ3 */
#ifndef MAIN_C
							;
#else
