...
static void AddSurfaceFlare(mapDrawSurface_t * ds, vec3_t entityOrigin)
{
	...
	DrawSurfaceForFlare(ds->entityNum, origin, ds->lightmapVecs[2], ds->shaderInfo->color, ds->shaderInfo->flareShader,
						ds->shaderInfo->lightStyle);
}
