...
#define Q_CONT_LADDER               0x00000400
...
#define	K_SURF_COLLISION			      0x20000	  /* don't draw but use for per polygon collision detection */
#define Q_SURF_DUST					        0x40000		/* leave a dust trail when walking on this surface */

#define Q_SURF_GRAVEL				        0x80000		 /* footsteps steps gravel */
#define Q_SURF_METALLIGHT			      0x100000	 /* footsteps metal light */
#define Q_SURF_RUG 				          0x200000	 /* footsteps steps rug */
#define Q_SURF_SNOW				          0x400000	 /* footsteps steps snow */
#define Q_SURF_WOOD				          0x800000	 /* footsteps steps wood */
//#define Q_SURF_ICE				          0x1000000	 /* footsteps steps ice */
#define Q_SURF_CRASS				        0x2000000	 /* footsteps steps crass */
#define Q_SURF_MARBLE				        0x4000000	 /* footsteps steps marble */
#define Q_SURF_TIN				          0x8000000	 /* footsteps steps tin */
...

{
...

	{
		...
		//{ "icesteps",		0,							0,							Q_SURF_ICE,					0,							0,							0 },
		{ "grassteps",		0,							0,							Q_SURF_CRASS,				0,							0,							0 },
