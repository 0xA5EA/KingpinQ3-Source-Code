...
void NMSG_WriteFloat(netmessage_t * msg, float c)
{
  ...
  bi.i = fi.i;
  msg->data[msg->size]     = bi.b[3];
  msg->data[msg->size + 1] = bi.b[2];
  msg->data[msg->size + 2] = bi.b[1];
  msg->data[msg->size + 3] = bi.b[0];
#else
...
void NMSG_WriteString(netmessage_t * msg, char *string)
{
	...
	strcpy((char*)&msg->data[msg->size], string);
...
#ifdef KMAP2_NO_TYPE_PUNNING
	bi.b[3] = msg->data[msg->read + 0];
	bi.b[2] = msg->data[msg->read + 1];
	bi.b[1] = msg->data[msg->read + 2];
	bi.b[0] = msg->data[msg->read + 3];
	fi.i = bi.i;
	msg->read += 4;
	return fi.f;
#else
