...
//hypov8 copied from ioquake UT4
/*
===============
Cmd_PVstr_f
...
void Cmd_Init(void)
{
	...
	Cmd_SetCommandCompletionFunc("vstr", Cvar_CompleteCvarName); //hypov8? not in kpq3?

	Cmd_AddCommand ("+vstr",Cmd_PVstr_f);//add hypov8
	Cmd_AddCommand ("-vstr",Cmd_PVstr_f);//add hypov8
