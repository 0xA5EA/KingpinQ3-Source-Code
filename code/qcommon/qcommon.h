...
#define PROTOCOL_VERSION 75    //74="beta"		75="dev build"		77=xreal 
//Q3 v1.31 - 67
...
#define UPDATE_SERVER_NAME "update.kingpinq3.com"       // 0xA5EA
// override on command line, config files etc.

#define MASTER_SERVER_NAME0 "master.kingpinq3.com"	// 0xA5EA Master. Only supports UDP 'ingame' type browser
#define MASTER_SERVER_NAME1 "master.kingpin.info"	// cnamed to active masters. currently M's master. UDP+TCP Gamespy
#define MASTER_SERVER_NAME2 "master.ioquake3.org"	// Only supports UDP 'ingame' type browser
...
//PRODUCT_NAME
#define PORT_MASTER 27950                               // 0xA5EA, org. 27900
#define PORT_UPDATE 27951                               //
#define PORT_SERVER 31600                               //31600  // 0xA5EA, org. 27960
...
//FXIME: is this used anywhere ?=
#define MAX_FILE_HANDLES 64

#ifdef DEDICATED
#   define Q3CONFIG_CFG "kpq3server.cfg"
#else
#   define Q3CONFIG_CFG "kingpinq3.cfg"
#endif
...
int FS_Write(const void *buffer, size_t len, fileHandle_t f);

int FS_Read2(void *buffer, size_t len, fileHandle_t f);
int FS_Read(void *buffer, size_t len, fileHandle_t f);
...
// 0xA5EA: had to change the prefix SE_ to SET_ due to name clashes with bspc build
typedef enum
{
	...
	SET_JOYSTICK_AXIS,   // evValue is an axis number and evValue2 is the current state (-127 to 127)
...
extern cvar_t *com_maxfps; // add hypo enforce lower frame rate. aids mouse invalid fix
...
extern cvar_t *com_3DNow;
extern cvar_t *com_MMX;
...
extern	cvar_t	*com_protocol; //hypov8 "com_protocol" "protocol"
...
#if 0 // defined(_DEBUG) && !defined(BSPC)
	#define ZONE_DEBUG
#endif
