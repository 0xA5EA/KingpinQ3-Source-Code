...
#if OLDMAP_VERSIONS //hypov8 todo: support old maps?
#define BSP_IDENT_Q2	(('P'<<24)+('S'<<16)+('B'<<8)+'I') //IDBSPHEADER
#define BSP_VERSION_Q2	38
//#if 0 // defined(COMPAT_Q3A) //hypov8 todo: q3 maps
#define BSP_IDENT_Q3	(('P'<<24)+('S'<<16)+('B'<<8)+'I') // little-endian "IBSP"
