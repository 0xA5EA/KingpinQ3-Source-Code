...
#ifndef AI_BM
#define AI_BM //hypov8 use new bot setup in bagy
#endif

#ifdef AI_BM
void BotBMRetreatGoals(bot_state_t *bs);   //add hypov8
void BotBMSeekGoals(bot_state_t *bs);	   //add hypov8
int BotBMCarryingCash(bot_state_t *bs);   //add hypov8
int BotBMCarryingStolen(bot_state_t *bs); //add hypov8
#endif
#if 0
...
#define CTF_FLAG_DRAGON		1
#define CTF_FLAG_NIKKI		2
//CTF skins
#define CTF_SKIN_DRAGONTEAM	"dragon"			//"red"
#define CTF_SKIN_NIKKITEAM	"nikki"				//"blue"
...
#ifdef AI_BM
// TODO: hypov8 AI_BM
extern bot_goal_t bm_dragonsafe;
extern bot_goal_t bm_nikkisafe;
extern bot_goal_t bm_cash; //hypov8 droped cash. should be cash and bags?
