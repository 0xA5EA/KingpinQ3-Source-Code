...
void AddRemap(const char *oldShader, const char *newShader, float timeOffset)
{
  ...
  for (i = 0; i < remapCount; i++)
  {
    if (Q_stricmp(oldShader, remappedShaders[i].oldShader) == 0)
    {
      ...
      qstrcpy(remappedShaders[i].newShader, newShader);
  ...
  {
    qstrcpy(remappedShaders[remapCount].newShader, newShader);
    qstrcpy(remappedShaders[remapCount].oldShader, oldShader);
