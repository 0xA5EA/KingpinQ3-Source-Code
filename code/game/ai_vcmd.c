...
void BotVoiceChat_Defend(bot_state_t *bs, int client, int mode)
{
   ...
   //
   switch(BotTeam(bs)) {
   case TEAM_DRAGONS: Com_Memcpy(&bs->teamgoal, &redobelisk, sizeof(bot_goal_t)); break;
   case TEAM_NIKKIS: Com_Memcpy(&bs->teamgoal, &blueobelisk, sizeof(bot_goal_t)); break;
   default: return;
   }
   }
   else
