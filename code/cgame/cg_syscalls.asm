...
equ trap_R_inPVS						  -88
equ trap_FS_Seek						  -89
equ trap_R_RegisterAnimation 			  -90
equ trap_R_RegisterShaderLightAttenuation -91
equ trap_R_AddRefLightToScene 			  -92
equ trap_R_CheckSkeleton				  -93
equ trap_R_BuildSkeleton				  -94
equ trap_R_BlendSkeleton				  -95
equ trap_R_BoneIndex					  -96
equ trap_R_AnimNumFrames				  -97
equ trap_R_AnimFrameRate        		  -98
...
equ acos					        	  -112
equ trap_CM_BiSphereTrace				  -113
equ trap_CM_TransformedBiSphereTrace 	  -114
equ trap_FS_GetFileList				      -115
equ trap_R_AddPolyBufferToScene           -117
