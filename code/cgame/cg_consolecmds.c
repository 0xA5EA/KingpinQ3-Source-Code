...
static void CG_scrollScoresDown_f(void)
{
  if (menuScoreboard && cg.scoreBoardShowing)
  {
    ...
    Menu_ScrollFeeder(menuScoreboard, FEEDER_DRAGONTEAM_LIST, qtrue);
    Menu_ScrollFeeder(menuScoreboard, FEEDER_NIKKITEAM_LIST, qtrue);
  }
}
...
static void CG_scrollScoresUp_f(void)
{
  if (menuScoreboard && cg.scoreBoardShowing)
  {
    ...
    Menu_ScrollFeeder(menuScoreboard, FEEDER_DRAGONTEAM_LIST, qfalse);
    Menu_ScrollFeeder(menuScoreboard, FEEDER_NIKKITEAM_LIST, qfalse);
  }
}
...
static consoleCommand_t commands[] =
{
  ...
  {"testParticels", CG_TestParticles_f},
  {"testbloodcloud", CG_TestBloodCloud_f},
  {"testblood", CG_TestParticleBlood_f},
  {"testrocketfire", CG_TestParticleRocketFire_f},
  {"testbloodpool", CG_TestParticleBloodPool_f},
  {"testbleed", CG_TestParticleBleed_f},
  {"testgibs", CG_TestGibs_f},
  {"testrand", CG_TestRand_f},
  {"testbigexplode", CG_TestBigExplode_f},
  {"testtelporteffect", CG_TestTeleportEffect_f},
#endif
