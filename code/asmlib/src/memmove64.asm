...
global memmoveU: function              ; Alternative version for processors with fast unaligned read
...
align 16
memmoveU:  ; Alternative version for processors with fast unaligned read
        PROLOGM memcpyU
...
%ifdef  UNIX
align   16    ; minimize 16-bytes boundaries in H1000 loop, Windows version is OK unless above code modified
%endif
