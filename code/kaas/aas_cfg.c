...
// FIXME: 0xA5EA, added because compiler didnt like float.h
...
void DefaultCfg(void)
{
	...
	cfg.bboxes[0].maxs[2] = 48; //edit hypov8 was = 32
	//bbox 1
	...
	cfg.bboxes[1].maxs[2] = 24; //edit hypov8 was = 16
	//
...
// Changes Globals:		-
//===========================================================================
#if 0 // 0xA5EA: redundant, defined in q_shared.c
