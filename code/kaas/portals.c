...
// Changes Globals:		-
//===========================================================================
int ClusterContents (bspnode_t *node)
{
	int		c1, c2, c;
...
// Changes Globals:		-
//===========================================================================
void AddPortalToNodes (portal_t *p, bspnode_t *front, bspnode_t *back)
{
...
// Changes Globals:		-
//===========================================================================
void RemovePortalFromNode (portal_t *portal, bspnode_t *l)
{
	portal_t	**pp, *t;
...
winding_t *BaseWindingForNode (bspnode_t *node)
{
	winding_t	*w;
	bspnode_t		*n;
	plane_t		*plane;
...
void MakeNodePortal (bspnode_t *node)
{
	...
	float		dist = 0.f;
	int			side;
	//FIXME (0xA5EA): side used as index uninitialised

	w = BaseWindingForNode (node);

	// clip the portal by all the other portals in the node
	for (side = 0, p = node->portals; p && w; p = p->next[side])
	{
		if (p->nodes[0] == node)
		{
			side = 0;
...
// Changes Globals:		-
//===========================================================================
void CalcNodeBounds (bspnode_t *node)
{
	portal_t	*p;
	int			s;
	int			i;
...
void MakeTreePortals_r (bspnode_t *node)
{
	int		i;
...
bspnode_t *p_firstnode;
bspnode_t *p_lastnode;
...
//===========================================================================
#ifdef P_NODESTACK
void P_AddNodeToList(bspnode_t *node)
{
...
// Changes Globals:		-
//===========================================================================
bspnode_t *P_NextNodeFromList(void)
{
	bspnode_t *node;
...
// Changes Globals:		-
//===========================================================================
void FloodPortals(bspnode_t *firstnode)
{
	bspnode_t *node;
	portal_t *p;
	int s;
...
void FloodPortals_r (bspnode_t *node, int dist)
{
	portal_t *p;
	int s;
//	int i;
...
// Changes Globals:		-
//===========================================================================
qboolean PlaceOccupant (bspnode_t *headnode, vec3_t origin, entity_t *occupant)
{
	bspnode_t *node;
	vec_t	d;
	plane_t *plane;
...
qboolean FloodEntities (tree_t *tree)
{
	...
	for (i = 1; i < num_entities; i++)
	{
		...
		if (lVectorCompare(origin, vec3_origin))
			continue;
	...
	{
		Log_Print("WARNING1: entity reached from outside\n");
	} //end else if
	Log_Print("inside %d\n", inside);
	Log_Print("inside && !tree->outside_node.occupied %d\n", inside && !tree->outside_node.occupied);
...
// Changes Globals:		-
//===========================================================================
void FillOutside_r (bspnode_t *node)
{
	if (node->planenum != PLANENUM_LEAF)
	{
...
// Changes Globals:		-
//===========================================================================
void FloodAreas_r (bspnode_t *node)
{
	portal_t	*p;
	int			s;
	bspbrush_t	*b;
...
// Changes Globals:		-
//===========================================================================
void FindAreas_r (bspnode_t *node)
{
	if (node->planenum != PLANENUM_LEAF)
	{
...
// Changes Globals:		-
//===========================================================================
void SetAreaPortalAreas_r (bspnode_t *node)
{
	bspbrush_t	*b;
	entity_t	*e;
...
// Changes Globals:		-
//===========================================================================
void MarkVisibleSides_r (bspnode_t *node)
{
	portal_t *p;
	int s;
