...
// Changes Globals:		-
//===========================================================================
void FindBrushInTree (bspnode_t *node, int brushnum)
{
	bspbrush_t	*b;
...
// Changes Globals:		-
//===========================================================================
void DrawBrushList (bspbrush_t *brush, bspnode_t *node)
{
	int		i;
	side_t	*s;
...
// Changes Globals:		-
//===========================================================================
bspnode_t *PointInLeaf (bspnode_t *node, vec3_t point)
{
	vec_t		d;
	plane_t		*plane;
...
// Changes Globals:		-
//===========================================================================
void LeafNode(bspnode_t *node, bspbrush_t *brushes)
{
	bspbrush_t *b;
	int i;
...
// Changes Globals:		-
//===========================================================================
void CheckPlaneAgainstParents (int pnum, bspnode_t *node)
{
	bspnode_t	*p;
...
// Changes Globals:		-
//===========================================================================
qboolean CheckPlaneAgainstVolume (int pnum, bspnode_t *node)
{
...
// Changes Globals:		-
//===========================================================================
side_t *SelectSplitSide (bspbrush_t *brushes, bspnode_t *node)
{
	int			value, bestvalue;
...
void SplitBrushList (bspbrush_t *brushes,
	bspnode_t *node, bspbrush_t **front, bspbrush_t **back)
{
...
bspnode_t *BuildTree_r (bspnode_t *node, bspbrush_t *brushes)
{
	bspnode_t		*newnode;
	side_t		*bestside;
	int			i, totalmem;
...
void AddNodeToQueue(bspnode_t *node)
{
	ThreadLock();
...
bspnode_t *NextNodeFromList(void)
{
	bspnode_t *node;
