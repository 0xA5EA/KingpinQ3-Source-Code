...
extern	dmodel_t		*q3_dmodels;//[MAX_MAP_MODELS];

extern	int				q3_numShaders;
extern	dshader_t	*q3_dshaders;//[Q3_MAX_MAP_SHADERS];

extern	int				q3_entdatasize;
extern	char			*q3_dentdata;//[Q3_MAX_MAP_ENTSTRING];

extern	int				q3_numleafs;
extern	dleaf_t		*q3_dleafs;//[Q3_MAX_MAP_LEAFS];

extern	int				q3_numplanes;
extern	dplane_t		*q3_dplanes;//[Q3_MAX_MAP_PLANES];

extern	int				q3_numnodes;
extern	dnode_t		*q3_dnodes;//[Q3_MAX_MAP_NODES];
...
extern	dbrush_t		*q3_dbrushes;//[Q3_MAX_MAP_BRUSHES];

extern	int				q3_numbrushsides;
extern	dbrushside_t	*q3_dbrushsides;//[Q3_MAX_MAP_BRUSHSIDES];
...
extern	dgridPoint_t *q3_gridData;//[Q3_MAX_MAP_LIGHTGRID];

extern	int				q3_numVisBytes;
extern	byte			*q3_visBytes;//[Q3_MAX_MAP_VISIBILITY];

extern	int				q3_numDrawVerts;
extern	drawVert_t	*q3_drawVerts;//[Q3_MAX_MAP_DRAW_VERTS];

extern	int				q3_numDrawIndexes;
extern	int				*q3_drawIndexes;//[Q3_MAX_MAP_DRAW_INDEXES];

extern	int				q3_numDrawSurfaces;
extern	dsurface_t	*q3_drawSurfaces;//[Q3_MAX_MAP_DRAW_SURFS];

extern	int				q3_numFogs;
extern	dfog_t		*q3_dfogs;//[Q3_MAX_MAP_FOGS];

extern	char			q3_dbrushsidetextured[MAX_MAP_BRUSHSIDES];
