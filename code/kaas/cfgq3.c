...
bbox	//30x30x56
{
	...
	flags			0x0000
	mins			{-15, -15, -24}
	maxs			{15, 15, 48} //edit hypov8 was = {15, 15, 32} //bot bounding box
} //end bbox
...
bbox	//30x30x40
{
	...
	flags			0x0001
	mins			{-15, -15, -24} //note hypov8 48units total crouch
	maxs			{15, 15, 24}  //edit hypov8 was = {15, 15, 16}
} //end bbox
//FIXME(0xA5EA): fix this for crouching issue ?
settings
{
