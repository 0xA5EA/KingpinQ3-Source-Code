...
void RE_RenderScene( const refdef_t *fd )
{
  ...
  Vector4Set(parms.viewportVerts[0], (float)parms.viewportX, (float)parms.viewportY, 0.f, 1.f );
  Vector4Set(parms.viewportVerts[1], (float)(parms.viewportX + parms.viewportWidth), (float)parms.viewportY, 0.f, 1.f);
  Vector4Set(parms.viewportVerts[2], (float)(parms.viewportX + parms.viewportWidth), (float)(parms.viewportY + parms.viewportHeight), 0.f, 1.f);
  Vector4Set(parms.viewportVerts[3], (float)parms.viewportX, (float)(parms.viewportY + parms.viewportHeight), 0.f, 1.f);
