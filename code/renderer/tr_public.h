...
//----(SA)
	...
	//int ( *LerpTag )( orientation_t *tag, qhandle_t handle, int startFrame, int endFrame, float frac, const char *tagNameIn );
...
// returned.
extern "C" Q_EXPORT refexport_t *GetRefAPI(int apiVersion, refimport_t *rimp);
