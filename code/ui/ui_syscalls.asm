...
equ trap_GetCpuConfig			            -110
equ trap_GetGlconfig2			            -111
equ trap_R_DrawRotatedPic                   -112
equ trap_R_RegisterAnimation                -112
equ trap_R_BuildSkeleton		            -113
equ trap_R_AnimNumFrames		            -114
equ trap_R_AnimFrameRate 		            -115
