...
extern vmCvar_t ui_joinWeaponMode;
...
extern vmCvar_t ui_fontTiny;
extern vmCvar_t ui_fontSmall;
extern vmCvar_t ui_fontBig;
extern vmCvar_t ui_fontHuge;
extern vmCvar_t ui_serverStatusTimeOut;

extern vmCvar_t ui_glTexturecompression;
...
// ui_cdkey.c
//
#ifndef STANDALONE // FIXME: 0xA5EA
...
typedef struct
{
  ...
  int numWeaponModes;
  weaponModeInfo weaponModes[MAX_WEAPONMODES];
...
#else
int trap_R_LerpTag(orientation_t *tag, clipHandle_t mod, int startFrame, int endFrame, float frac, const char *tagName); //add hypov8
#endif
