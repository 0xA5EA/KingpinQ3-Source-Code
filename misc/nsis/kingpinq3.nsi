...
Section "kingpinq3 (required)"
  ...
  ; Put file there
 ;File "../../build/release-win32/kpq3ded.exe"
  File "../../build/release-win32/kingpinq3.exe"
 ; File "../../COPYING.txt"
 ; File "../../README.txt"
;  File "../../id-readme.txt"
;  File "../../voip-readme.txt"
  ...
  File "../../build/release-win32/basekpq3/cgamex86.dll"
  File "../../build/release-win32/basekpq3/qagamex86.dll"
  File "../../build/release-win32/basekpq3/uix86.dll"
;  SetOutPath "$INSTDIR\missionpack"
;  File "../../build/release-win32/missionpack/cgamex86.dll"
;  File "../../build/release-win32/missionpack/qagamex86.dll"
;  File "../../build/release-win32/missionpack/uix86.dll"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\kingpinq3\kingpinq3.lnk" "$INSTDIR\kingpinq3.exe" "" "$INSTDIR\kingpinq3..exe" 0
...
;  Delete $INSTDIR\missionpack\uix86.dll
  Delete $INSTDIR\kingpinq3.exe
 ; Delete $INSTDIR\kpq3ded.exe
